...
func NewGetHeadersMessage(blockLocator []*bc.Hash, amount int, skip int) *GetHeadersMessage {
...
func (m *GetHeadersMessage) GetAmount() int {
	return m.Amount
}

func (m *GetHeadersMessage) GetSkip() int {
	return m.Skip
}
