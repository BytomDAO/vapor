...
func TestFilterAccountUtxo(t *testing.T) {
	...
	cases := []struct {
		...
		{
			dbPrograms: map[string]*account.CtrlProgram{
				"73746f72653a023a2a37a64a4e15a772ab43bf3f5956d0d1f353946496788e7f40d0ff1796286a6f": &account.CtrlProgram{
		...
		},
		{
			dbPrograms: map[string]*account.CtrlProgram{
				...
				"73746f72653a023adb4d86262c12ba70d50b3ca3ae102d5682436243bd1e8c79569603f75675036a": &account.CtrlProgram{
