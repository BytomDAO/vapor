...
func TestListTransactions(t *testing.T) {
	cases := []struct {
		...
		// 	height:      uint64(100),
		// 	accountID:   "",
		// 	startTxID:   hex.EncodeToString([]byte{0x02, 0x01, 0x51, 0x31, 0x71, 0x30, 0xd4, 0x3b, 0x3d, 0xe3, 0xdd, 0x80, 0x67, 0x29, 0x9a, 0x5e, 0x09, 0xf9, 0xfb, 0x2b, 0xad, 0x5f, 0x92, 0xc8, 0x69, 0xd1, 0x42, 0x39}),
		// 	count:       uint(2),
		// 	unconfirmed: true,
		// 	want: []*query.AnnotatedTx{
		// 		// &query.AnnotatedTx{
